  ...
  return (
    <>
      <div className="bg-[#001E24]">
        <section className="px-4 md:px-16 pt-15">
          <div className="">
            <div className="flex flex-col lg:flex-row items-center gap-10">
              ...
              <div className="lg:w-3/5 text-white">
                <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-7 uppercase">
                  The Start
                </h2>
                <p className="text-gray-300 leading-[3rem] tracking-[3px] font-thin text-2xl">
