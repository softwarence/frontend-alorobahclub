...
const ChamferCard = ({ id, img, title }: Slide) => {
  ...
  return (
    <div className="cut-corner relative w-full max-w-full md:max-w-[385px] xl:max-w-full rounded-xl overflow-hidden shadow-xl group max-h-[600px]">
      <div className="overflow-hidden">
        <Image
          ...
          src={img}
          alt={title}
          className="w-full h-[420px] md:h-[500px] lg:h-[600px] object-cover transition-transform duration-500 group-hover:scale-105 hover:cursor-pointer"
          draggable={false}
        />
      </div>
  ...
  const slides: Slide[] = [
    {
      id: 9,
      img: img1,
      title: "Club Secures Major Sponsorship Deal with Global Brand",
      desc: "Lorem ipsum",
    },
    {
      id: 10,
      img: img2,
      title: "Youth Players Benefit from New Health & Wellness Program",
      desc: "Lorem ipsum",
    },
    {
      id: 11,
      img: img3,
      title: "Fans Join Exclusive Open Training Session",
      desc: "Lorem ipsum",
    },
    {
      id: 12,
      img: img1,
      title: "New Football Academy Opens in Jeddah",
      desc: "Lorem ipsum",
    },
    {
      id: 13,
      img: img2,
      title: "Upcoming Friendly Match Officially Announced",
      desc: "Lorem ipsum",
    },
    {
      id: 14,
      img: img3,
      title: "Full Details Revealed for Upcoming Friendly Match",
      desc: "Lorem ipsum",
    },
  ];
