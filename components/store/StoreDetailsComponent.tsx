...
import StoreImageSlider from "./../shared/StoreImageSlider";
...
// --- MAIN COMPONENT ---
export default function StoreDetailsComponent() {
    ...
    <div className="w-full text-white py-8 sm:py-12 md:py-16 px-4 md:px-8 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16">
        ...
        <div className="col-span-3">
          <StoreImageSlider></StoreImageSlider>
        </div>

        {/* RIGHT SIDE — PRODUCT DETAILS */}
        <div className="space-y-4 md:space-y-3 col-span-2">
          {/* TITLE + PRICE */}
          <div>
