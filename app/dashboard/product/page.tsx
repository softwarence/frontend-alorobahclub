...
export default function ProductCreateThreeColumn() {
  const [tags, setTags] = useState(["Sports", "Accessories"]);
  ...
  const addVariant = () => {
    setVariants([...variants, { color: "", size: "", price: 0, sku: "", stock: 0 }]);
  };
  ...
  const [categories, setCategories] = useState(["New arrival", "Men's collection", "Sports"]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="flex justify-between items-center mb-5">
        ...
        <h1 className="text-2xl pr-6"> Product meta</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-5 space-y-6">
          ...
          <div>
            <h1 className="text-2xl mb-7 "> Product description</h1>
        ...
        <div className="xl:col-span-5 space-y-6">
          ...
          <Card title="Product variant">
            ...
            <button onClick={addVariant} className="flex items-center gap-1 text-sm text-gray-600">
        ...
        <div className="xl:col-span-2 space-y-6">
          <Card title="Tags">
            ...
            <input
              className="w-full border rounded px-2 py-2 text-sm mb-1.5 mt-2 semi-bold"
              placeholder="Add tag"
              value={tagInput}
              onChange={(e) => setTagInput(e.target.value)}
              onKeyDown={(e) => e.key === "Enter" && addTag()}
            />
            <button onClick={addTag} className="border rounded px-4 p-1 mx-auto  text-sm ">
              Add tag
            </button>
          </Card>
        </div>
